                        ...
                        <div class="row">
                            <div class="col">
                                <p class="text-muted small mb-0">
                                    ...
                                    </a> đã đánh giá <span class="text-dark">10</span> <i
                                        style="color: #f6c343!important" class="fa fa-star" aria-hidden="true"></i>
                ...
                <div class="mb-3">
                    ...
                    <div class="bg-white border border-top-0 p-3">
                        ...
                        <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                            <img class="img-fluid" style="height: 80px !important; width: 100px !important;"
                                 src="img/<%=movie.getImage()%>" alt="">
                            <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                <div class="mb-2">
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2"
                                       href=""></a>
                                    <a class="text-body" href=""><small><%=movie.getReleaseDate()%>
                                    </small></a>
                                </div>
                                <a class="h6 m-0 text-secondary text-uppercase font-weight-bold"
                                   href="review.jsp?id=<%=movie.getId()%>"><%=movie.getDescription().substring(0, 40)%>
                                    ....</a>
                            </div>
                        </div>
                        <%
